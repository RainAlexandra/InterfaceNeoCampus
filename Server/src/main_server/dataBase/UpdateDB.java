...
/**
 * class of functions the update the database
 * @author RainAlex
 */
public class UpdateDB {
	 ...
	 * @param authorUserName the author of the ticket to be created
	 * @param groupName the designated group
	...
	/**
	 * @param authorUserName the author of the message
	 * @param idTicket the id of the ticket where the message is to be written
	 * @param text the contents of the message
	 * @return the membersOfGroup the members of the group that the message concerns
	 */
	...
	/**
	 * @return the date which the message was submitted
	 */
